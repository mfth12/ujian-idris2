        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="password-old" name="password-old" placeholder="Password lama">
            </div>
            <div class="form-group">
              <label>Password baru</label>
              <input type="password" class="form-control" id="password-new" name="password-new" placeholder="Password baru">
            </div>
            <div class="form-group">
              <label>Password konfirmasi</label>
              <input type="password" class="form-control" id="password-confirm" name="password-confirm" placeholder="Password konfirmasi">
            </div>
          </div>
        </div>
