...
<section class="content-header">
	<h1>
		...
		<small>Export Rekapitulasi Hasil Ujian ke Excel</small>
	</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Pilih Grup peserta yang akan di export Hasil Ujian nya pada bagian samping halaman ini, dan pilih rentang waktu Ujian tersebut dikerjakan.</p>
	...
	<div class="row">
		...
		<div class="col-md-8">
            <div class="box">
				<div class="box-header with-border">
					<div class="box-title">Rekapitulasi Hasil Ujian</div>
    			</div><!-- /.box-header -->
