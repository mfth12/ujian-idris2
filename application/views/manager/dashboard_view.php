...
<section class="content">
	...
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif Sistem Ujian Idris, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
    <div class="box">
        <div class="box-header with-border">
            <div class="box-title">Konfigurasi Sistem</div>
        </div><!-- /.box-header -->
    ...
    <div class="box box-success box-solid">
        ...
        <div class="box-body">
        	<dl>
                ...
                <dt>Data Ujian</dt>
                <dd>
                	Kelompok Data Ujian digunakan untuk mengatur Ujian, mengevaluasi jawaban essay, dan melihat Hasil Ujian.
                	<ol>
                		<li>Tambah Ujian</li>
                		<li>Daftar Ujian</li>
                		<li>Evaluasi Ujian</li>
                		<li>Hasil Ujian</li>
                		<li>Token</li>
                	</ol>
                </dd>
				<dt>Laporan</dt>
                <dd>
                	Laporan digunakan untuk menampilkan analisis butir soal, dan rekap hasil Ujian.
                	<ol>
                		<li>Analisis Butir Soal</li>
                        <li>Rekap Hasil Ujian</li>
                	</ol>
                </dd>
                <dt>Tool</dt>
                <dd>
