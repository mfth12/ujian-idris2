...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Hasil Ujian Detail</li>
	</ol>
</section>
            ...
            <div class="box">
                ...
                <div class="box-body form-horizontal">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Waktu Ujian Mulai</label>
                            <div class="col-sm-9">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="#" onclick="refresh_table()">Refresh Detail Ujian</span></a>
                        </div>
                    </div><!-- /.box-header -->
