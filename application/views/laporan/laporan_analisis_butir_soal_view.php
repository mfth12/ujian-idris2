...
<section class="content-header">
	<h1>
		...
		<small>Analisis Butir Soal seusia dengan grup dan ujian yang dipilih</small>
	</h1>
	<ol class="breadcrumb">
	...
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Pilih Grup peserta dan Ujian untuk mendapatkan analisis butir soal.</p>
		...
		<div class="col-sm-12">
			<div class="box">
				<div class="box-header with-border">
					<div class="box-title">Pilih Grup dan Ujian</div>
				</div><!-- /.box-header -->
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<span class="help-block">Pilih Nama Ujian yang akan dianalisis soalnya</span>
						</div>
					</div>
				</div>
