...
<section class="content-header">
    <h1>
        Selamat Datang
        <small> di Halaman Masuk Administrator Ujian <?php if(!empty($site_name)){ echo $site_name; } ?></small>
    </h1>
</section>

<!-- Main content -->
<section class="content" style="padding: 65px;">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default mt-4">
                <div class="box-header with-border">
                    <h3 class="box-title">Masuk Operator</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open('welcome/login','id="form-login" class="form-horizontal"')?>
                    ...
                    <div class="box-footer">
                        <button type="submit" id="btn-login" class="btn btn-info pull-right" >Masuk</button>
                    </div><!-- /.box-footer -->
                </form>
            </div><!-- /.box -->
        <div class="col-md-3"></div>
