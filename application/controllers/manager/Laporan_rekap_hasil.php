...
class Laporan_rekap_hasil extends Member_Controller {
    ...
    public function index(){
        ...
        $this->template->display_admin($this->kelompok.'/laporan_rekap_hasil_tes_view', 'Rekapitulasi Hasil Ujian', $data);        
    }
    ...
    public function export(){
        ...
        $filename = 'Data Rekap Hasil Ujian - '.$nama_grup.'.xlsx'; //save our workbook as this file name
