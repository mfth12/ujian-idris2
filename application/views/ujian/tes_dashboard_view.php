<div class="container">
    ...
    <section class="content-header">
    	<h1>
    		SELAMAT DATANG <?php if(!empty($nama)){ echo $nama; } if(!empty($group)){ echo ' | Kelas '.$group; } ?>
    ...
    <section class="content">
		<?php
			if(!empty($informasi)){
				...
				<div class="callout callout-info">
					<h4>Informasi</h4>
					<p>Silahkan pilih Ujian yang diikuti dari daftar tes yang tersedia dibawah ini. Apabila tes tidak muncul, silahkan menghubungi Operator yang bertugas.</p>
				</div>
				<?php
			}
		?>
