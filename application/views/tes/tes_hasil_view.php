                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
								...
								<span class="help-block" id="info-waktu">Rentang waktu peserta saat memulai Ujian</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="pilih-status" id="pilih-status" class="form-control input-sm">
                                    <option value="mengerjakan">Peserta Mengerjakan Ujian</option>
									<option value="tidak">Peserta Belum Mengerjakan Ujian</option>
                                </select>
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="pilih-keterangan" id="pilih-keterangan" placeholder="Keterangan Peserta Ujian" class="form-control input-sm" />
                            </div>
                        </div>
                        <div class="form-group">
	...
	<div class="row">
        ...
        <div class="col-xs-12">
			<div class="box">
                ...
                <div class="box-footer">
                    <button type="button" id="btn-edit-pilih" title="Pilih Hasil Ujian" class="btn btn-default pull-right">Pilih Semua</button>
                    ...
                    <button type="button" id="btn-edit-buka-tes" class="btn btn-primary">Buka Ujian</button>
                    ...
                    <div class="modal-body">
                        <div class="row-fluid">
                            <div class="box-body">
                                ...
                                <p class="">Menambah Waktu Ujian melalui Penambahan "Waktu Mulai" pada user tes yang sudah dicentang sebelumnya.</p>
                                <p class="">Waktu Mulai pengerjaan Ujian hasil penambahan tidak boleh melebihi waktu saat ini.</p>
                            </div>
                        </div>
                    </div>
    ...
    $(function(){
		...
		$("#pilih-status").change(function(){
            if($('#pilih-status').val()=='mengerjakan'){
				$('#info-waktu').html('Rentang waktu peserta saat memulai Ujian');
			}else{
				$('#info-waktu').html('Rentang waktu Ujian dilaksanakan sesuai di Daftar Ujian');
			}
        });
