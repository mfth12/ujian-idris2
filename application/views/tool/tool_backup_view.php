...
<section class="content">
		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Database</b> untuk melakukan Backup database sistem. Simpan backup database pada tempat yang aman.</p>
        ...
        <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar, audio) pada Sistem. Simpan backup data pada tempat yang aman.</p>
                        <p>Data file yang di upload akan disimpan dalam bentuk archive.</p>
                        <p>Restore Data Upload dilakukan dengan meng-copy data ke folder uploads pada folder utama Sistem</p>
                    </div>
	...
	<div class="row">
		<div class="col-md-6">
                <div class="box">
                    <div class="box-header with-border">
    					<div class="box-title">Bersihkan Sessions</div>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <span id="form-pesan-database"></span>
                        <p>Klik tombol <b>Clear Sessions</b> untuk membersihkan sessions peserta tes yang disimpan di tabel cbt_sessions.</p>
                        <p>Setelah Sistem digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>
					...
					<div class="box-footer">
                        <button type="submit" class="btn btn-primary" id="backup-session">Bersihkan</button>
                    </div>
                </div>
        </div>
	</div>
