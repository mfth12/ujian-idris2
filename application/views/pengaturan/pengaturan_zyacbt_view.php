			...
			<?php echo form_open($url.'/simpan','id="form-pengaturan"'); ?>
                <div class="box">
                    <div class="box-header with-border">
    					<!-- <div class="box-title">Daftar Pengaturan MAZAYA CBT</div> -->
                    </div>
					<!-- /.box-header -->
                    ...
                    <div class="box-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p class="help-block">
									Nama Pelaksana Sistem Ujian.<br />
                                    Digunakan sebagai identitas pelaksanaan Ujian.
								</p>
							</div>
						</div>
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p class="help-block">
									Keterangan Pelaksana ujian bisa diisi dengan Slogan ataupun Alamat dari Organisasi.
								</p>
							</div>
						</div>
						<div class="form-group">
