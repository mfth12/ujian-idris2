                    ...
                    <div class="box-header with-border">
						...
						<div class="box-tools pull-right">
    							<div class="dropdown pull-right">
    								<a style="cursor: pointer;" onclick="manual()">Token Ujian Manual</a>
    							</div>
    						</div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="manual-token" name="manual-token" placeholder="Token Ujian">
								<span class="help-block">Pastika Token Ujian Manual belum pernah digunakan pada hari yang sama.</span>
                            </div>
